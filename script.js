...
const REVIEWS_DATA = [
  ...
  { id: 2,  name: 'Mohammed L.',  date: '10 juni 2024',  rating: 5, text: 'Smartwatch besteld als retourproduct en hij is inderdaad bijna nieuw. Werkt verder perfect, batterij gewoon goed.', product: 'Smartwatch Series 6', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 6,  name: 'Tom B.',       date: '6 juni 2024',   rating: 4, text: 'Retourproduct besteld en het was bijna nieuw. Alleen het doosje was open geweest. Voor de rest geen punt.', product: 'Premium Espressomachine', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 8,  name: 'Daan S.',      date: '4 juni 2024',   rating: 5, text: 'Verwachting was niet zo hoog, maar positief verrast. Smartwatch ziet er echt als nieuw uit.', product: 'Smartwatch Series 6', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 12, name: 'Bram W.',      date: '30 mei 2024',   rating: 4, text: 'Bureau is stevig en ziet er netjes uit. Wel een klein krasje op de hoek, maar dat stond ook aangegeven. Voor de prijs prima.', product: 'Houten Bureau 140cm', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 14, name: 'Jeroen P.',    date: '26 mei 2024',   rating: 5, text: 'Tweedehands maar je merkt er niks van. Battery was zelfs 98%. Top service van Lagenco.', product: 'Draadloze Koptelefoon', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 17, name: 'Sophie T.',    date: '20 mei 2024',   rating: 5, text: 'Stoel is comfortabel en ziet er netjes uit. Levering was sneller dan verwacht. Aanrader voor wie duurzaam wil inkopen.', product: 'Ergonomische Kantoorstoel', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
  ...
  { id: 20, name: 'Yusuf K.',     date: '14 mei 2024',   rating: 5, text: 'Koptelefoon is geluidstechnisch echt goed. Voor de prijs kan je dit niet beter krijgen. Goed gecontroleerd.', product: 'Draadloze Koptelefoon', hasPhoto: true, photo: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>' },
...
const REVIEWS_PHOTO_URLS = {
  ...
  'Smartwatch Series 6':       'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>',
  'Draadloze Koptelefoon':     'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>',
  'Ergonomische Kantoorstoel': 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>',
  'Houten Bureau 140cm':       'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>',
  'Premium Espressomachine':   'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>'
};
...
const buildReviewCard = (r) => {
  const photoHtml = r.hasPhoto
    ? `<div class="review-card-photo">
         <img src="${r.photo || REVIEWS_PHOTO_URLS[r.product] || 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'><rect width='400' height='300' fill='%23FFF8F0'/><circle cx='200' cy='150' r='60' fill='%23D5EDDA'/><text x='200' y='165' font-size='40' text-anchor='middle' fill='%236BBF7E' font-family='Arial' font-weight='bold'>L</text></svg>'}" alt="Foto bij review van ${escapeHtml(r.name)}" loading="lazy" decoding="async">
       </div>`
    : '';
  return `
